...
import { dataAccTransactionAllLot, dataStatusAllLot, type IFilterAllLot } from '../type';
...
export default function Filter({ setFilter, filter, subButton, isStatus }: IProps) {
