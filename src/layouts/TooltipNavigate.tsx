...
export default function TooltipNavigate({
  ...
  return (
    <Tooltip
      content={
        <div className="text-[var(--color-text)] bg-[var(--color-background)] rounded-lg py-1 px-2">{t(title)}</div>
      }
    ...
    >
      <Button
        ...
        } cursor-pointer inline-block p-2 rounded-lg active shadow-md shadow-gray-500 ${className}`}
        aria-current="page"
      >
